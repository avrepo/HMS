...
<form name="form1" method="post" action="RoomProcess" >
 <%@ page import ="java.sql.*,dbconnection.*,bean.* " %>
    <%! ResultSet rs,rs2,rs3; %>
	    <%! String  n,r,name,place,country,zip,phone,fax,email,roomtype,roomnumber,persons,intime,outtime,rent,status,rent_day; %>
    ...
    rs= con.executeQuery("select * from  room_customer where name='"+n+"' and room_number='"+r+"'");
	rs2=con.executeQuery("select * from  room_details where name='"+n+"' and room_number='"+r+"'");   
	rs3=con.executeQuery(" select rent from room_types where room_type=(select room_type from room where room_number='"+r+"')");
	if(rs3.next())
	{
  ...
  <p align="center"><strong><a href="Main_menu.htm"><font color="#FF0000"><em>Back</em></font></a></strong></p>
</form>
  </fieldset> </CENTER>
</body>
</html>
